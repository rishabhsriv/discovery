...
public class TestService
{
    ...
    {
        equivalenceTester()
                .addEquivalentGroup(new Service(Id.valueOf("beb73711-0725-47c3-9305-a69d8c344c1e"), Id.valueOf("3c8285d0-bd0d-4fe2-8321-7ebcd065607b"), "blue", "poolA", "/locationA",
                                                ImmutableMap.of("key", "valueA")),
                                    new Service(Id.valueOf("beb73711-0725-47c3-9305-a69d8c344c1e"), Id.valueOf("3c8285d0-bd0d-4fe2-8321-7ebcd065607b"), "blue", "poolA", "/locationA",
                                                ImmutableMap.of("key", "valueA")))
                .addEquivalentGroup(new Service(Id.valueOf("a0592d5d-b42b-4376-a651-be973ad97750"), Id.valueOf("3c8285d0-bd0d-4fe2-8321-7ebcd065607b"), "blue", "poolA", "/locationA",
                                                ImmutableMap.of("key", "valueA")),
                                    new Service(Id.valueOf("a0592d5d-b42b-4376-a651-be973ad97750"), Id.valueOf("3c8285d0-bd0d-4fe2-8321-7ebcd065607b"), "blue", "poolA", "/locationA",
                                                ImmutableMap.of("key", "valueA")))
                .check();
    }
            ...
            throws IOException
    {
        ...
        Service parsed = codec.fromJson(Resources.toString(Resources.getResource("service.json"), UTF_8));
